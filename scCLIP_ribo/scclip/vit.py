...
class ViTConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # ensure compatibility with transformers.ViTModel pooler
        self.pooler_output_size = hidden_size
        self.pooler_act = "tanh"
        # transformers attention backend selector (avoid KeyError None)
...
class ViTModel(nn.Module):
    ...
    def forward(
        ...
        # Simplify to avoid version mismatches: do not request extra outputs
        return_dict = False
        ...
        sequence_output = encoder_outputs[0] if isinstance(encoder_outputs, (tuple, list)) else encoder_outputs.last_hidden_state
